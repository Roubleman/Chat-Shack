...
class Player {
    ...
    private void checkFogOfWar(){
        theCommunicator.sendFogOfWar(fogOfWar);
        boolean opponentFoW = theCommunicator.getFogOfWar();
        if (opponentFoW != fogOfWar) {
            theGUI.showDisagreement();
            goFromBeginning();
        }
    }
