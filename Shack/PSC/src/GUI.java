...
public class GUI {
    ...
    void showDisagreement() {
        JOptionPane.showMessageDialog(theFrame, "Failed: Disagreeing on fog of war");
    }
    ...
    void showTime(Boolean isRunning, String time, String opponentTime) {
        ...
        myTime.setFont(new Font("TimesRoman", Font.BOLD, 24));
